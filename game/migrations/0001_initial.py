# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-06-05 21:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_server', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='server.GameServer')),
                ('status', models.PositiveIntegerField(choices=[(0, b'Dost\xc4\x99pny'), (1, b'Rozgrywka w trakcie')], default=0)),
            ],
            options={
                'db_table': 'rooms',
            },
